class OrdersController < ApplicationController
  ...
  def submit_invoice
    ...
    if @cart_items.empty?
      redirect_to root_path,
                  alert: "Your cart is empty. Please add items before submitting the invoice."
      return
    end
  ...
  def order_params
    params.expect(order: [:total, :order_date,
                          { order_details_attributes: %i[product_id quantity price_at_purchase total] }])
  end
